...
} from "./chunk-QYICLN72.js";
import {
  config,
  getIonMode,
  getPlatforms,
  isPlatform
} from "./chunk-DIQG4PJJ.js";
import {
  doc
...
var Platform = class _Platform {
   ...
   * @hidden
   */
  backButton = new import_rxjs2.Subject();
  /**
   * The keyboardDidShow event emits when the
   * on-screen keyboard is presented.
   */
  keyboardDidShow = new import_rxjs2.Subject();
  /**
   * The keyboardDidHide event emits when the
   * on-screen keyboard is hidden.
   */
  keyboardDidHide = new import_rxjs2.Subject();
  /**
   ...
   */
  pause = new import_rxjs2.Subject();
  /**
   * The resume event emits when the native platform pulls the application
   * out from the background. This event would emit when a Cordova app comes
   * out from the background, however, it would not fire on a standard web browser.
   */
  resume = new import_rxjs2.Subject();
  /**
...
var IonRouterOutlet = class _IonRouterOutlet {
  ...
  currentActivatedRoute$ = new import_rxjs2.BehaviorSubject(null);
  activated = null;
  /** @internal */
  ...
  activateWith(activatedRoute, environmentInjector) {
    ...
    if (enteringView) {
      ...
      const component$ = new import_rxjs2.BehaviorSubject(null);
  ...
  proxyObservable(component$, path) {
    return component$.pipe(
      ...
      (0, import_operators2.filter)((component) => !!component),
      (0, import_operators2.switchMap)((component) => this.currentActivatedRoute$.pipe((0, import_operators2.filter)((current) => current !== null && current.component === component), (0, import_operators2.switchMap)((current) => current && current.activatedRoute[path]), (0, import_operators2.distinctUntilChanged)()))
    );
  }
  /**
...
var RoutedComponentInputBinder = class _RoutedComponentInputBinder {
  ...
  subscribeToRouteData(outlet) {
    ...
    const dataSubscription = (0, import_rxjs2.combineLatest)([activatedRoute.queryParams, activatedRoute.params, activatedRoute.data]).pipe((0, import_operators2.switchMap)(([queryParams, params, data], index) => {
...
@ionic/core/components/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DXPXYZVF.js.map
